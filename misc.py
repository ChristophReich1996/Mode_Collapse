...
def get_discriminator() -> nn.Module:
    ...
    :return: (nn.Module) Simple feed forward neural network with two layers and probability output.
    '''
    return nn.Sequential(nn.Linear(2, 10), nn.LeakyReLU(), nn.Linear(10, 1), nn.Sigmoid())
